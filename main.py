...
async def set_lang(message: types.Message):
    ...
    await message.answer("👋 Welcome to VERO!" if lang == "en" else "👋 Добро пожаловать в VERO!", reply_markup=get_main_menu())
    
    msg = await message.answer("⏳ Анализирую последние новости через VERO AI..." if lang == "ru" else "⏳ Analyzing latest news via VERO AI...")
